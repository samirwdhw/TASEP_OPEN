...
#define P 1.0		//Probability of car moving
...
#define FILE_NAME "results_beta_try.dat"	//File to output data
#define FILE_NAME_CURRENT "current3.dat"	//File to output current
#define WARM_UP T_MAX/10	//Time for which warmup is assumed

float alpha = 1;		//Probability of a particle entering
float beta  = 0.0;		//Probability of a particle leaving
